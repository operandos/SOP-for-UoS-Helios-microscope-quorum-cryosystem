...
> **Note**  **It is important to line the cryostage up with the direction that samples are transferred into the chamber!**  
...
> **Note**  
> Always set the anticontaminator to a lower temperature than the stage, so that contamination will be deposited preferentially on the anticontaminator rather than the specimen.  
